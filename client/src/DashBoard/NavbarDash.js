...
function NavbarDashboard() {
  ...
  return (
    <nav className="w-full top-0  bg-gray-900 text-1xl font-bold">
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4 ">
        ...
        <div className={`flex flex-col md:flex-row items-center space-x-3 md:space-x-0 rtl:space-x-reverse ${isOpen ? 'block' : 'hidden'} md:block`}>
          <ul className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 ">
            ...
            <li>
              <a href="/dash" className="text-white hover:text-blue-700">Workspaces</a>
            </li>
            <li>
              <a href="/Timeline" className="text-white hover:text-blue-700">Feature</a>
            </li>
            <li>
